                                    ...
                                    <div class="chart tab-pane active" id="revenue-chart"
                                        ...
                                        <table class="table table-head-fixed text-nowrap">
                                            ...
                                            <tr class="text-center">
                                                <th class="col-1 align-top">ID</th>
                                                <th class="align-top">User</th>
                                                <th class="col-1 align-top">Action</th>
                                                <th class="col-1 align-top">Created at</th>
                                                <th class="col-1 align-top">Updated at</th>
                                            </tr>
                                            </thead>
                                            <tbody>
                                            ...
                                            @foreach($users as $user)
                                                <tr class="odd">
                                                    <td align="center" class="dtr-control">{{$user->id}}</td>
                                                    <td>{{$user->name}}</td>
                                                    <td>
                                                        <div class="d-flex justify-content-center">
                                                            <a href="{{route('task.show', $user->id)}}" class="mr-3">
                                                                <i class="fa-solid fa-eye"></i>
                                                            </a>
                                                            <a href="{{route('task.edit', $user->id)}}"
                                                               class="mr-3 text-success">
                                                                <i class="fa-solid fa-pencil"></i>
                                                            </a>
                                                            <form action="{{route('task.delete', $user->id)}}"
                                                                  method="POST">
                                                                @csrf
                                                                @method('DELETE')
